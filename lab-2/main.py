...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--sim-time", type=float, default=5_000.0)
    ...
    exp.add_argument("--sim-time", type=float, default=5_000.0)
    exp.add_argument("--warmup-fraction", type=float, default=0.1)
    exp.add_argument("--replications", type=int, default=100)
