...
\begin{itemize}
    ...
    \item \textbf{Simulation Parameters:}
          \begin{itemize}
              \item Simulation time per run: 20,000 seconds
              \item Warmup period: 2,000 seconds (10\% of simulation time)
              \item Independent replications: 30 runs per configuration
              \item Total configurations: 16 (4 scenarios $\times$ 4 arrival rates)
              \item Total replication runs: 480
          \end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Average Response Time:} Mean time from arrival to departure
          \begin{equation}
...
where:
\begin{itemize}
    \item $\bar{x}$ is the sample mean across 30 replications
    \item $s$ is the sample standard deviation
    \item $t_{0.975}(n-1)$ is the two-sided t critical value (e.g., $t_{0.975}(29) \approx 2.045$)
    \item $n = 30$ is the number of replications
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1-avg_n_system.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1-avg_wait_queue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1-throughput.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1-drop_probability.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K4-avg_n_system.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K4-avg_wait_queue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K4-throughput.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K4-drop_probability.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K8-avg_n_system.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K8-avg_wait_queue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K8-throughput.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM1K8-drop_probability.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM3K8-avg_n_system.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM3K8-avg_wait_queue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM3K8-throughput.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{plots/MM3K8-drop_probability.png}
...
Potential extensions to this simulator:

\begin{itemize}
    \item \textbf{Non-Exponential Distributions:} Implement phase-type service times or deterministic service for specialized workloads.
    \item \textbf{Priority Queues:} Add priority-based scheduling (e.g., real-time vs. batch jobs).
    \item \textbf{Heterogeneous Servers:} Allow servers with different service rates.
    \item \textbf{Transient Analysis:} Study behavior during startup transients or load ramps.
    \item \textbf{Network of Queues:} Model multi-stage systems with routing between stages.
    \item \textbf{Adaptive Control:} Implement dynamic server provisioning based on observed queue depth.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Run experiments: \texttt{uv run python main.py experiments}
